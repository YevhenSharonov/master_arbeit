...
# scenario log, update model_draft.ego_grid_hvmv_substation table with new column of respective osmtgmod bus_i, 
# fill table with bus_i from osmtgmod, scenario log
