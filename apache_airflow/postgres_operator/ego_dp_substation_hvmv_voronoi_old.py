...
# scenario log, set id as subst_id, index GIST (geom), scenario log
    set_id_as_subst_id = PostgresOperator(
...
# Gemeindeschlüssel, scenario log
    gemeindeschluessel = PostgresOperator(
...
# metadata, select description, scenario log
    create_dummy_points_for_voronoi_calculation = PostgresOperator(
...
# delete dummy points from substations and voronoi (18 Points), metadata, select description, scenario log
    voronoi_polygons_with_eucldean_distance = PostgresOperator(
    ...
    set_id_as_subst_id >> gemeindeschluessel >> create_dummy_points_for_voronoi_calculation >> voronoi_polygons_with_eucldean_distance
